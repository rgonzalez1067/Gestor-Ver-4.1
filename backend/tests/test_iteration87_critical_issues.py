...
Base URL: https://modulo-inactivo-nav.preview.emergentagent.com
"""
import pytest
import requests
import os
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://modulo-inactivo-nav.preview.emergentagent.com').rstrip('/')
