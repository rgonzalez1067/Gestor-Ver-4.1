...
Base URL: https://tech-spec-downloader.preview.emergentagent.com
"""
import pytest
import requests
import os
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://tech-spec-downloader.preview.emergentagent.com').rstrip('/')
