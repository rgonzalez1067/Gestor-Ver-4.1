...
Base URL: https://workflow-management-3.preview.emergentagent.com
"""
import pytest
import requests
import os
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://workflow-management-3.preview.emergentagent.com').rstrip('/')
