...
Base URL: https://notif-assign.preview.emergentagent.com
"""
import pytest
import requests
import os
...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://notif-assign.preview.emergentagent.com').rstrip('/')
