...
export const VARIABLE_CATEGORIES = [
  ...
  },
  {
    ...
    vars: [
      ...
      { key: 'Motivo_Cambio_Estatus', label: 'Motivo / Justificación del último cambio de estado' },
      { key: 'Estatus_Anterior', label: 'Estado anterior (antes del último cambio)' },
      { key: 'Fecha_Cambio_Estatus', label: 'Fecha del último cambio de estado' },
      { key: 'Usuario_Cambio_Estatus', label: 'Usuario que hizo el último cambio de estado' },
      { key: 'Motivo_Congelamiento', label: 'Motivo del congelamiento (estatus Congelado)' },
      { key: 'Dias_Congelado', label: 'Días acumulados en estatus Congelado' },
