...
const DEFAULT_EXAMPLE_VALUES = {
  ...
  Matriz_Avance_Proyecto: '<div style="margin:6px 0 10px;padding:8px 12px;border-radius:8px;background:#f0f6ff;border:1px solid #cfe0f5;font-family:Arial,sans-serif;font-size:13px;"><b>Avance Global del Proyecto:</b> <span style="color:#2563eb;font-weight:800;">62%</span></div><table style="border-collapse:collapse;width:100%;font-family:Arial,sans-serif;font-size:13px;"><thead><tr style="background:#2c3e50;color:white;"><th style="padding:8px 10px;text-align:left;border:1px solid #ddd;">Banco / Producto</th><th style="padding:8px 10px;border:1px solid #ddd;">Recibido</th><th style="padding:8px 10px;border:1px solid #ddd;">Configurado</th><th style="padding:8px 10px;border:1px solid #ddd;">Testeado</th><th style="padding:8px 10px;border:1px solid #ddd;">En Producción</th></tr></thead><tbody><tr style="background:#e8eef5;font-weight:bold;color:#1f3a5f;"><td colspan="5" style="padding:6px 10px;border:1px solid #e9ecef;">Banco: Bancamiga</td></tr><tr><td style="padding:6px 10px 6px 22px;border:1px solid #e9ecef;">Tarjeta de Crédito/Débito</td><td style="padding:6px 10px;border:1px solid #e9ecef;text-align:center;color:#16a34a;font-weight:700;">100%</td><td style="padding:6px 10px;border:1px solid #e9ecef;text-align:center;color:#d97706;font-weight:700;">50%</td><td style="padding:6px 10px;border:1px solid #e9ecef;text-align:center;color:#9ca3af;">—</td><td style="padding:6px 10px;border:1px solid #e9ecef;text-align:center;color:#9ca3af;">—</td></tr></tbody></table>',
  Matriz_Avance_Proyecto_Con_Fecha: '<div style="margin:6px 0 10px;padding:8px 12px;border-radius:8px;background:#f0f6ff;border:1px solid #cfe0f5;font-family:Arial,sans-serif;font-size:13px;"><b>Avance Global del Proyecto:</b> <span style="color:#2563eb;font-weight:800;">62%</span></div><table style="border-collapse:collapse;width:100%;font-family:Arial,sans-serif;font-size:13px;"><thead><tr style="background:#2c3e50;color:white;"><th style="padding:8px 10px;text-align:left;border:1px solid #ddd;">Banco / Producto</th><th style="padding:8px 10px;border:1px solid #ddd;">Recibido</th><th style="padding:8px 10px;border:1px solid #ddd;">Configurado</th><th style="padding:8px 10px;border:1px solid #ddd;">Testeado</th><th style="padding:8px 10px;border:1px solid #ddd;">En Producción</th></tr></thead><tbody><tr style="background:#e8eef5;font-weight:bold;color:#1f3a5f;"><td colspan="5" style="padding:6px 10px;border:1px solid #e9ecef;">Banco: Bancamiga</td></tr><tr><td style="padding:6px 10px 6px 22px;border:1px solid #e9ecef;">Tarjeta de Crédito/Débito</td><td style="padding:6px 10px;border:1px solid #e9ecef;text-align:center;color:#16a34a;font-weight:700;">100%<div style="font-size:10px;color:#64748b;font-weight:400;margin-top:2px;">10/06/2026</div></td><td style="padding:6px 10px;border:1px solid #e9ecef;text-align:center;color:#d97706;font-weight:700;">50%<div style="font-size:10px;color:#64748b;font-weight:400;margin-top:2px;">11/06/2026</div></td><td style="padding:6px 10px;border:1px solid #e9ecef;text-align:center;color:#9ca3af;">—</td><td style="padding:6px 10px;border:1px solid #e9ecef;text-align:center;color:#9ca3af;">—</td></tr></tbody></table>',
  Matriz_Seguimiento_Evolutiva: '<div style="font-family:Arial,sans-serif;font-size:12px;font-weight:600;color:#475569;margin:6px 0 8px;">Matriz de Seguimiento Evolutiva &middot; Todos los bancos <span style="font-weight:400;color:#94a3b8;">&mdash; formato celda: % avance / cajas estimadas / cajas recibidas</span></div><div style="margin:0 0 16px;"><div style="font-family:Arial,sans-serif;font-size:13px;font-weight:700;color:#16324f;background:#dbeafe;padding:7px 12px;border-left:4px solid #1f3a5f;border-radius:4px;margin-bottom:6px;">BLOQUE: Banco A</div><table style="border-collapse:collapse;width:100%;font-family:Arial,sans-serif;"><thead><tr style="background:#1f3a5f;color:#fff;"><th style="padding:7px 10px;border:1px solid #d8dee9;text-align:left;font-size:11px;">Estructura del Cliente</th><th style="padding:7px 9px;border:1px solid #d8dee9;text-align:center;font-size:11px;">PRODUCTO: Cr&eacute;dito<br/><span style="font-weight:400;opacity:.85;">(Fase Recibido)</span></th><th style="padding:7px 9px;border:1px solid #d8dee9;text-align:center;font-size:11px;">PRODUCTO: Cr&eacute;dito<br/><span style="font-weight:400;opacity:.85;">(Fase Configurado)</span></th><th style="padding:7px 9px;border:1px solid #d8dee9;text-align:center;font-size:11px;">PRODUCTO: D&eacute;bito<br/><span style="font-weight:400;opacity:.85;">(Fase Recibido)</span></th></tr></thead><tbody><tr><td colspan="4" style="padding:6px 10px;border:1px solid #d8dee9;background:#e8eef5;color:#1f3a5f;font-weight:700;font-size:12px;">RIF: Comercio XYZ &mdash; RIF: J-00343075-7</td></tr><tr><td style="padding:6px 10px;border:1px solid #d8dee9;font-size:11px;color:#334155;"><span style="color:#94a3b8;">&#9492;&#9472;</span> Sucursal Caracas Centro</td><td style="padding:6px 9px;border:1px solid #d8dee9;text-align:center;font-size:11px;color:#16a34a;font-weight:700;">100% / 5 / 5</td><td style="padding:6px 9px;border:1px solid #d8dee9;text-align:center;font-size:11px;color:#d97706;font-weight:700;">50% / 5 / 2</td><td style="padding:6px 9px;border:1px solid #d8dee9;text-align:center;font-size:11px;color:#16a34a;font-weight:700;">100% / 5 / 5</td></tr><tr><td style="padding:6px 10px;border:1px solid #d8dee9;font-size:11px;color:#334155;"><span style="color:#94a3b8;">&#9492;&#9472;</span> Sucursal El Hatillo</td><td style="padding:6px 9px;border:1px solid #d8dee9;text-align:center;font-size:11px;color:#16a34a;font-weight:700;">100% / 2 / 2</td><td style="padding:6px 9px;border:1px solid #d8dee9;text-align:center;font-size:11px;color:#64748b;font-weight:700;">0% / 2 / 0</td><td style="padding:6px 9px;border:1px solid #d8dee9;text-align:center;font-size:11px;color:#16a34a;font-weight:700;">100% / 2 / 2</td></tr></tbody></table></div>',
